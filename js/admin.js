    ...
    let html = `
        <div class="mb-5 flex flex-col gap-4 border-b border-gray-200 pb-5 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex w-full gap-2 overflow-x-auto pb-1 custom-scrollbar md:w-auto">
                ...
                ${filterButton('Pending', 'Pending', 'bg-amber-700')}
                ${filterButton('Approved', 'Approved', 'bg-emerald-700')}
                ${filterButton('Declined', 'Declined', 'bg-rose-800')}
            </div>
        </div>
    `;
                ...
                actionButtons = `
                    <div class="flex flex-wrap justify-center gap-2">
                        <button
                            ...
                            class="min-w-[78px] flex-1 rounded-sm border border-emerald-800 bg-emerald-800 px-3 py-2 text-[11px] font-semibold text-white transition-colors hover:bg-emerald-900">
                            Approve
                        </button>
                        <button
                            type="button"
                            onclick="openDeclineModal('${booking.ID_RESERVE}')"
                            class="min-w-[78px] flex-1 rounded-sm border border-rose-300 bg-white px-3 py-2 text-[11px] font-semibold text-rose-800 transition-colors hover:bg-rose-50">
                            Decline
                        </button>
                    </div>`;
            } else {
